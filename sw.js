...
*/
const CACHE_NAME = 'cumplimiento-ff-v4'; // sube este número cada vez que cambies el HTML, para forzar la actualización
const ASSETS = ['./', './index.html', './manifest.json', './icon-192.png', './icon-512.png', './benchmark.html', './incentivos.html'];
